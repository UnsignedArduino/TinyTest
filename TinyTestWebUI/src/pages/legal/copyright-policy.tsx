...
export function CopyrightPolicy({
  ...
  return (
    <Layout
      ...
      appProps={appProps}
      description="TinyTest's copyright policy."
      keywords="TinyTest, Chess, Engine, Chess engine, Chess engine testing, Testing, Distributed, Legal, Legal stuff, Copyright policy"
      breadCrumbs={[
        { Legal: "/legal" },
