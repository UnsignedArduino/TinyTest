...
export function PrivacyPolicy({
  ...
  return (
    <Layout
      ...
      appProps={appProps}
      description="TinyTest's privacy policy."
      keywords="TinyTest, Chess, Engine, Chess engine, Chess engine testing, Testing, Distributed, Legal, Legal stuff, Privacy policy"
      breadCrumbs={[
        { Legal: "/legal" },
