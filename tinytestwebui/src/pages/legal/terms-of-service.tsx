...
export function TermsOfService({
  ...
  return (
    <Layout
      ...
      appProps={appProps}
      description="TinyTest's terms of service."
      keywords="TinyTest, Chess, Engine, Chess engine, Chess engine testing, Testing, Distributed, Legal, Legal stuff, Terms of service"
      breadCrumbs={[
        { Legal: "/legal" },
